...
```javascript
atleast2d = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-atleast2d@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var atleast2d = require( 'path/to/vendor/umd/ndarray-base-atleast2d/index.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-atleast2d@umd/browser.js"></script>
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/ndarray-base-atleast2d.svg
[npm-url]: https://npmjs.org/package/@stdlib/ndarray-base-atleast2d

[test-image]: https://github.com/stdlib-js/ndarray-base-atleast2d/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/ndarray-base-atleast2d/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/ndarray-base-atleast2d/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/ndarray-base-atleast2d?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/ndarray-base-atleast2d.svg
[dependencies-url]: https://david-dm.org/stdlib-js/ndarray-base-atleast2d/main
...
[deno-url]: https://github.com/stdlib-js/ndarray-base-atleast2d/tree/deno
[deno-readme]: https://github.com/stdlib-js/ndarray-base-atleast2d/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/ndarray-base-atleast2d/tree/umd
[umd-readme]: https://github.com/stdlib-js/ndarray-base-atleast2d/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/ndarray-base-atleast2d/tree/esm
[esm-readme]: https://github.com/stdlib-js/ndarray-base-atleast2d/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/ndarray-base-atleast2d/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/ndarray-base-atleast2d/main/LICENSE
